...
// Fetch drinks from the database in descending order by productName
$query = "SELECT * FROM PRODUCTS ORDER BY productName DESC";
$drinks = [];

try {
    // Fetch all products in descending order
...
if (isset($_GET['delete_id'])) {
    ...
    $stmt->execute();
    header("Location: descending.php");  // Refresh the page after deletion
}
?>
...
<head>
    ...
    <title>Cold Drink Cafe - Descending Order</title>
</head>
<body>
    <main>
        <div class="header">
